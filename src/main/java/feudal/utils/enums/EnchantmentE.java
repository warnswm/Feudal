...
public enum EnchantmentE {
    ...
    public static @Nullable Enchantment getByID(int id) {
        ...
        for (EnchantmentE enchantmentE : values())
            if (enchantmentE.getId() == id)
                return enchantmentE.getEnchantment();
    ...
    public static Enchantment getRandomEnchantment() {
        return EnchantmentE.getByID(ThreadLocalRandom.current().nextInt(1, 31));
    }
