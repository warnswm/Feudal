...
public enum AnimalsForShepherd {
    ...
    public static int getByEntity(EntityType entity) {
        for (AnimalsForShepherd animalsForShepherd : values())
            if (animalsForShepherd.getEntity() == entity)
                return animalsForShepherd.attributeExp;
        return 0;
    }
}
